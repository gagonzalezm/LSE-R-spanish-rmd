--- 
title: "Aprendiendo estadísticas con R: Un tutorial para estudiantes de psicología y principiantes.(Version 0.6.1)"
author: "Danielle Navarro (bookdown translation: Emily Kothe). Traductores versión en Español, Gabriel A. Gonzalez M. y Natalia Escobar"
date: "`r Sys.Date()`"
...
link-citations: yes
description: "*Aprendiendo estadísticas con R* cubre el contenido de una clase introductoria de estadística, como típicamente se enseña a los estudiantes de psicología de pregrado, centrándose en el uso del software estadístico R
output:
  bookdown::gitbook:
    css: style.css
    config:
...
## Prefacio de traducción al español
