...
knitr::include_graphics(file.path(projecthome, "img", "estimation", "srs1.eps"))
```
...
knitr::include_graphics(file.path(projecthome, "img/estimation/brs.eps"))

```

```{r srs2, fig.cap="Simple random sampling *with* replacement from a finite population", echo=FALSE}
knitr::include_graphics(file.path(projecthome, "img/estimation/srs2.eps"))
...
knitr::include_graphics(file.path(projecthome,"img","estimation","samplingDist4.eps"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/samplingDistMax.eps"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/samplingDistSampleSD.eps"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/biasMean.eps"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/confIntReplicated.eps"))
