...
knitr::include_graphics(file.path(projecthome, "img","regression2","scatter3d_1.eps"))
...
knitr::include_graphics(file.path(projecthome, "img","regression2","unusual_outlier.eps"))
...
knitr::include_graphics(file.path(projecthome, "img","regression2", "unusual_leverage.eps"))
...
knitr::include_graphics(file.path(projecthome, "img","regression2","unusual_influence.eps"))
...
knitr::include_graphics(file.path(projecthome, "img","regression2","residhist.eps"))
